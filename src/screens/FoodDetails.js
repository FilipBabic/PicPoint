...
import { View, Image, ScrollView, Text, TouchableOpacity, TouchableWithoutFeedback, TouchableHighlight, Linking, Dimensions } from 'react-native';
        ...
        <View style={{ backgroundColor: '#f2fbfc', height: '100%' }}>
            <ScrollView>
                ...
                <View style={{ fontSize: 14, padding: 20, textAlign: 'center' }}>
                    ...
                    <Text style={{ paddingTop: 10, fontFamily: 'Poppins-Bold', fontSize: 18, fontWeight: 'bold' }}>
                        Working hours:
                    </Text>
                    <View>
